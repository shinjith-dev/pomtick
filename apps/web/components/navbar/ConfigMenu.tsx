...
const ConfigMenu = ({ config, updateConfig }: Props) => {
  ...
  return (
    <div className="sm:relative" ref={ref}>
      ...
      {expanded && (
        <div className="absolute right-0 top-14 z-20 w-screen min-w-72 rounded-md px-4 py-2 sm:-right-6 sm:top-8 sm:w-auto">
          <ul className="h-full space-y-1 rounded-md bg-surface p-2 font-medium shadow-md">
            <li>
              <p className="my-1 border-b border-highlight-med text-sm text-muted">
                General
              </p>
            </li>
